...
// WalletConnect
export const [walletConnect, walletConnectHooks] = initializeConnector<WalletConnect>((actions: any) => {
...
// Coinbase
// export const [coinbase, coinbaseHooks] = initializeConnector<CoinbaseWallet>((actions: any) => {
...
// GnosisSafe
// export const [gnosisSafe, gnosisSafeHooks] = initializeConnector<GnosisSafe>((actions: any) => new GnosisSafe({actions}))

// network, view on nodeUrl()
export const [network, networkHooks] = initializeConnector<Network>((actions: any) => {
...
export const WALLETS = [Wallet.WALLET_CONNECT, Wallet.INJECTED]
...
export function useConnectors(selectedWallet: Wallet | undefined) {
  return useMemo(() => {
    const connectors: ConnectorListItem[] = [{connector: walletConnect, hooks: walletConnectHooks}]
    if (selectedWallet) {
